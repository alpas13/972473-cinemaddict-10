...
export default class Popup extends AbstractSmartComponent {
  ...
  getTemplate() {
    const {poster, age, title: {name, rating}, director, writers, actors, releaseDate, runtime, country, genre, description, isAddToWatchList, isWatched, isFavorite} = this._detailData;
  ...
  _subscribeOnEvents() {
    ...
    this.getElement().querySelector(`#watched`).addEventListener(`change`, () => {
      this._detailData.isWatched = !this._detailData.isWatched;
      this.rerender();
    });

    this.getElement().querySelector(`#favorite`).addEventListener(`change`, () => {
      this._detailData.isFavorite = !this._detailData.isFavorite;
      this.rerender();
    });
